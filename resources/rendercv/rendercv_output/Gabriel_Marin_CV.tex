...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://github.com/gbrlmarn}{{\footnotesize\faGithub}\hspace*{0.13cm}gbrlmarn}}%
    \end{header}
    ...
    \section{Skills}
        ...
        \begin{onecolentry}
            \textbf{Programming Languages:} C, C++, Clojure, Go, Java, Rust, Bash, Python, Scheme, Common Lisp, HTML, CSS, LaTeX, Erlang, Elixir, C\#, SQL, NoSQL, Datomic
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Tools:} Linux, Git, Emacs, Coreutils, Docker, ZeroMQ, Boost, Make, CMake, Vim, Jenkins, Yocto, BitBake, RabbitMQ, Django, Hugo, React
        \end{onecolentry}
